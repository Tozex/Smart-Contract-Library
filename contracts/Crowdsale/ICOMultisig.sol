...
contract ICOMultisig is  Pausable {
  ...
  constructor(
    ...
    IERC20 _usdcToken,
    IERC20 _token, 
    tozRatio = _tozRatio.mul(10);  /* multiple by 100 to manage decimals eg ( 0.1 toz per token equal to 10) */
    usdcRatio = _usdcRatio.mul(10); /* multiple by 100 to manage decimals eg ( 0.5 usdc per token equal to 50) */
